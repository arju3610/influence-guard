...
def process_data(df):
    ...
    try:
        ...
        # Keep the product output clear: only flagged accounts should display
        # estimated fake followers in the results table.
        df.loc[df['account_status'] == "Real", 'fake_followers'] = 0
        df['fake_followers_ratio'] = df['fake_followers'] / df['follower_count']
